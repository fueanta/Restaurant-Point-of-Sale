...
-- Generated 2017.12.28 21:30:48 by ADMIN
-- This script can be run in sqlplus as the owner of the Oracle Apex owner.
begin
    wwv_flow_api.set_security_group_id(p_security_group_id=>4778302063074200);
end;
/
----------------
-- W O R K S P A C E
...
wwv_flow_fnd_user_api.create_company (
  p_id                           => 4778400304074216,
  p_provisioning_company_id      => 4778302063074200,
  p_short_name                   => 'POS',
...
wwv_flow_fnd_user_api.create_fnd_user (
  p_user_id      => '4778216702074200',
  p_user_name    => 'FUEANTA',
  p_first_name   => 'Taqui',
  p_last_name    => 'Ahmad',
  p_description  => '',
  p_email_address=> 'fueanta@gmail.com',
  p_web_password => '6128E6AA2B7EFD58882DAD8D10833439',
  p_web_password_format => 'HEX_ENCODED_DIGEST_V2',
  p_group_ids    => '',
  p_developer_privs=> 'ADMIN:CREATE:DATA_LOADER:EDIT:HELP:MONITOR:SQL',
  p_default_schema=> 'POS',
  p_account_locked=> 'N',
  p_account_expiry=> to_date('201712010000','YYYYMMDDHH24MI'),
